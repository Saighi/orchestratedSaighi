...
int main(int ac, char* av[]) 
{
	...
	P10Connection_delayed * con_ee;
	con_ee = new P10Connection_delayed(neurons_e,neurons_e,
			wee,sparseness,
			eta,
			kappa,
			wmax,
	...
	// External input
	P10Connection_delayed * con_stim_e = NULL;
	con_stim_e = new P10Connection_delayed( stimgroup, neurons_e,
		wext,sparseness_ext,
		eta,
