...
int main(int ac, char* av[]) 
{
	...
	P10Connection_nofas * con_ee;
	con_ee = new P10Connection_nofas(neurons_e,neurons_e,
			wee,sparseness,
			eta,
			kappa,
			wmax
	...
	// STP parameters
	con_ee->set_tau_d(taud);
	con_ee->set_ujump(0.45);
	con_ee->set_urest(0.45);
	...
	// External input
	P10Connection_nofas * con_stim_e = NULL;
	con_stim_e = new P10Connection_nofas( stimgroup, neurons_e,
		wext,sparseness_ext,
		eta,
	...
	con_stim_e->set_ujump(0.45);
	con_stim_e->set_urest(0.45);
