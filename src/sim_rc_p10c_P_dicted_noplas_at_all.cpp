...
int main(int ac, char* av[]) 
{
	...
	con_ee = new SparseConnection(neurons_e,neurons_e,wee,sparseness);
	...
	SparseConnection * con_i2e;
	con_i2e = new SparseConnection(neurons_i2,neurons_e,wie,sparseness);
	con_i2e->set_name("I2E");

	// External input
	SparseConnection * con_stim_e = NULL;
	con_stim_e = new SparseConnection( stimgroup, neurons_e,wext,sparseness_ext,GLUT);
