...
#ifndef P10CONNECTION_NOFAS_H_
#define P10CONNECTION_NOFAS_H_

#include "auryn.h"

#define P10DECAYTERM_H 4.0
#define P10CONNECTION_NOFAS_EULERUPGRADE_STEP 0.99

namespace auryn {

class P10Connection_nofas : public DuplexConnection
{
...
public:
	...
	P10Connection_nofas(SpikingGroup * source, NeuronGroup * destination, TransmitterType transmitter=GLUT);

	P10Connection_nofas(SpikingGroup * source, NeuronGroup * destination, 
			const char * filename, 
			AurynFloat eta=1, 
	...
	P10Connection_nofas(SpikingGroup * source, NeuronGroup * destination, 
			...
			AurynFloat kappa=3., AurynFloat maxweight=100. , 
			TransmitterType transmitter=GLUT,
			string name = "P10Connection_nofas" );

	virtual ~P10Connection_nofas();
